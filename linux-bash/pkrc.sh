...
covid_moh_git="https://raw.githubusercontent.com/MoH-Malaysia/covid19-public/main/epidemic/pkrc.csv"
my_covid_file="pkrc.csv"
wget=$(which wget)
db_name="covid19_MY"
table_name="my_covid_pkrc"
db_user="gadmin"
datafile=/var/lib/mysql-files/pkrc.csv
countfile="pkrc_cnt.txt"
...
use covid19_MY
select count(*) from my_covid_pkrc
EOF
