...
covid_moh_git="https://raw.githubusercontent.com/MoH-Malaysia/covid19-public/main/epidemic/icu.csv"
my_covid_file="icu.csv"
wget=$(which wget)
db_name="covid19_MY"
table_name="my_covid_icu"
db_user="gadmin"
datafile=/var/lib/mysql-files/icu.csv
countfile="icu_cnt.txt"
...
use covid19_MY
select count(*) from my_covid_icu
EOF
