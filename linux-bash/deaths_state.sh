...
covid_moh_git="https://raw.githubusercontent.com/MoH-Malaysia/covid19-public/main/epidemic/deaths_state.csv"
my_covid_file="deaths_state.csv"
wget=$(which wget)
db_name="covid19_MY"
table_name="my_covid_deaths_state"
db_user="gadmin"
datafile=/var/lib/mysql-files/deaths_state_load.csv
countfile="death_state_cnt.txt"
...
use covid19_MY
select count(*) from my_covid_deaths_state
EOF
