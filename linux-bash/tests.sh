...
covid_moh_git="https://raw.githubusercontent.com/MoH-Malaysia/covid19-public/main/epidemic/tests_malaysia.csv"
my_covid_file="tests_malaysia.csv"
wget=$(which wget)
db_name="covid19_MY"
table_name="my_covid_tests"
db_user="gadmin"
datafile=/var/lib/mysql-files/tests_malaysia.csv
countfile="tests_malaysia_cnt.txt"
...
use covid19_MY
select count(*) from my_covid_tests
EOF
