...
covid_moh_git="https://raw.githubusercontent.com/MoH-Malaysia/covid19-public/main/epidemic/tests_state.csv"
my_covid_file="tests_state.csv"
wget=$(which wget)
db_name="covid19_MY"
table_name="my_covid_tests_state"
db_user="gadmin"
datafile=/var/lib/mysql-files/tests_state.csv
countfile="tests_state_cnt.txt"
...
use covid19_MY
select count(*) from my_covid_tests_state
EOF
...
function new_data {
	cd $rootdir/log
        ...
        if [[ $rcount -gt 0 ]]; then
                ...
                echo "5. New Record/s Count: $(wc -l < $datafile)"
        else
		cd $rootdir/data
                echo "No Data"
